...
// server-only, FAIL-SOFT (mirrors platform/db/integrations.ts + the chat repo).
// The bytes live in Supabase Storage (platform/storage/supabase.ts); this table
// only tracks the pointer + processing status. Tenancy is enforced by userId.
// ─────────────────────────────────────────────────────────────────────────────
