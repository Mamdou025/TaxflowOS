...
"[project]/shared/workflow-engine/codegen/workflow-codegen-shared.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/shared/workflow-engine/codegen/workflow-codegen.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$plugins$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/plugins/index.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$plugins$2f$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/plugins/registry.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shared/workflow-engine/codegen/workflow-codegen-shared.ts [app-ssr] (ecmascript)");
;
;
...
function generateWorkflowCode(nodes, edges, options = {}) {
    ...
    const usedNodeOutputs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["analyzeNodeUsage"])(nodes);
    ...
    for (const node of nodes){
        ...
        if (node.data.type === "action") {
            ...
            const baseVarName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toFriendlyVarName"])(label, actionType);
            // Ensure uniqueness
            varName = baseVarName;
            let counter = 1;
    ...
    function processAtFormat(trimmed, match) {
        ...
        const accessPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildAccessPath"])(fieldPath);
    ...
    function convertTemplateToJS(template) {
        ...
        return template.replace(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TEMPLATE_PATTERN"], (match, expression)=>{
    ...
    function convertConditionToJS(condition) {
        ...
        const cleaned = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["removeInvisibleChars"])(condition);
        // Then convert template references
        const converted = cleaned.replace(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TEMPLATE_PATTERN"], (match, expression)=>{
            const trimmed = expression.trim();
            if (trimmed.startsWith("@")) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["removeInvisibleChars"])(converted);
    }
    // Helper functions to generate code for different action types
    function generateEmailActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("Send Email");
    ...
    function generateTicketActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("Create Ticket");
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
    ...
    function generateDatabaseActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("Database Query");
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
    ...
    function generateHTTPActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("HTTP Request");
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
    ...
    function processAiSchema(aiSchema) {
        ...
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toTypeScriptLiteral"])(schemaWithoutIds);
        } catch  {
            // If schema is invalid JSON, skip it
            return null;
        }
    ...
    function generateAiTextActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("Generate Text");
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
    ...
    function generateSlackActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("Send Slack Message");
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
    ...
    function generateFirecrawlActionCode(node, indent, varName) {
        const actionType = node.data.config?.actionType;
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])(actionType);
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
    ...
    function generateV0CreateChatActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("Create Chat");
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
    ...
    function generateV0SendMessageActionCode(node, indent, varName) {
        const stepInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$codegen$2f$workflow$2d$codegen$2d$shared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStepInfo"])("Send Message");
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
   ...
   */ function generatePluginActionCode(node, actionType, indent, varName) {
        ...
        imports.add(`import { ${stepInfo.functionName} } from '${stepInfo.importPath}';`);
        const config = node.data.config || {};
        const configFields = (0, __TURBOPACK__imported__module__$5b$project$5d2f$plugins$2f$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flattenConfigFields"])(action.configFields);
   ...
   */ function buildPluginConfigParams(config, actionType, indent) {
        ...
        const params = [];
        for (const field of (0, __TURBOPACK__imported__module__$5b$project$5d2f$plugins$2f$registry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flattenConfigFields"])(action.configFields)){
            const value = config[field.key];
            if (value === undefined || value === null || value === "") {
                continue;
            }
...
"[project]/shared/workflow-engine/domain/workflow/inspector-rules.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/shared/workflow-engine/domain/workflow/block-types.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/shared/workflow-engine/codegen/codegen-templates/condition.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/shared/workflow-engine/codegen/codegen-templates/database-query.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/shared/workflow-engine/codegen/codegen-templates/http-request.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AnimatedBorder = ({ className })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-5cf7e4472ecfab9b" + " " + ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("pointer-events-none absolute inset-0 rounded-[inherit] animate-border-mask", className) || ""),
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-5cf7e4472ecfab9b" + " " + ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("pointer-events-none absolute inset-0 rounded-[inherit] border-2 border-blue-500/10", className) || "")
            }, void 0, false, {
                fileName: "[project]/shared/ui/animated-border.tsx",
                lineNumber: 71,
                columnNumber: 7
...
//# sourceMappingURL=shared_04167cde._.js.map