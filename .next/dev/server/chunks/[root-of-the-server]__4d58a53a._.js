...
"[project]/features/assistant/runtime/memory/repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function insertMemory(input) {
    try {
        const [row] = await __TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"]).values(input).returning();
        return row ?? null;
    } catch (err) {
...
async function listMemoriesForUser(userId, limit = 200) {
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"]).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$drizzle$2d$orm$40$0$2e$44$2e$7_$40$opentel_83c64c1d7edcb9d78a3dfae58927e46e$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"].userId, userId)).orderBy((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$drizzle$2d$orm$40$0$2e$44$2e$7_$40$opentel_83c64c1d7edcb9d78a3dfae58927e46e$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$select$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["desc"])(__TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"].createdAt)).limit(limit);
    } catch (err) {
...
async function deleteMemory(userId, id) {
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].delete(__TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"]).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$drizzle$2d$orm$40$0$2e$44$2e$7_$40$opentel_83c64c1d7edcb9d78a3dfae58927e46e$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["and"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$drizzle$2d$orm$40$0$2e$44$2e$7_$40$opentel_83c64c1d7edcb9d78a3dfae58927e46e$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"].id, id), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$drizzle$2d$orm$40$0$2e$44$2e$7_$40$opentel_83c64c1d7edcb9d78a3dfae58927e46e$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"].userId, userId))).returning({
            id: __TURBOPACK__imported__module__$5b$project$5d2f$platform$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assistantMemories"].id
        });
        return res.length > 0;
    } catch (err) {
...
"[project]/features/assistant/runtime/memory/retrieval.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function keywordOverlap(query, m) {
...
function selectRelevantMemories(rows, scope, limit = 20) {
    ...
    scored.sort((a, b)=>b.clientMatch - a.clientMatch || b.overlap - a.overlap || b.recency - a.recency);
    return scored.slice(0, limit).map((s)=>s.m);
}
}),
"[project]/features/assistant/runtime/memory/types.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SaveMemoryInputSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    content: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1).max(2000),
    subject: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().max(200).optional(),
    kind: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum(MEMORY_KINDS).optional(),
    clientId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().max(200).nullish(),
    fiscalYear: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1900).max(3000).nullish(),
    workflowId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().max(200).nullish(),
...
"[project]/app/api/assistant/memory/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/assistant/runtime/memory/repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$retrieval$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/assistant/runtime/memory/retrieval.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/assistant/runtime/memory/types.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    ...
    const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listMemoriesForUser"])(userId);
    const relevant = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$retrieval$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["selectRelevantMemories"])(rows, {
        clientId,
        fiscalYear
    });
...
async function POST(req) {
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SaveMemoryInputSchema"].safeParse(body);
    if (!parsed.success) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: 'INVALID_INPUT',
    ...
    const d = parsed.data;
    const row = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["insertMemory"])({
        userId,
        content: d.content,
    ...
    if (!row) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
...
async function DELETE(req) {
    ...
    if (!id) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
        error: 'MISSING_ID'
    }, {
        status: 400
    });
    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$assistant$2f$runtime$2f$memory$2f$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteMemory"])(userId, id);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d58a53a._.js.map