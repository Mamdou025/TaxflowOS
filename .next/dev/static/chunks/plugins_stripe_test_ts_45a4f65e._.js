...
"[project]/plugins/stripe/test.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function testStripe(credentials) {
    try {
        ...
        if (!apiKey.startsWith("sk_")) {
            return {
                success: false,
                error: "Invalid API key format. Stripe secret keys start with 'sk_live_' or 'sk_test_'"
            };
        }
...
//# sourceMappingURL=plugins_stripe_test_ts_45a4f65e._.js.map