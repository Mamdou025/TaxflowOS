...
const BuilderPage = ()=>{
    ...
    const focusRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$jotai$40$2$2e$15$2e$1_$40$babel$2b$core$40$7$2e$_5b27b7b535d6519f6427fc26ba88e66f$2f$node_modules$2f$jotai$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAtomValue"])(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$state$2f$workflow$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["builderFocusTargetAtom"]));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BuilderPage.useEffect": ()=>{
            ...
            if (focus) {
                ...
                const cfg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$runtime$2f$workflow$2d$runs$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getWorkflowConfig"])(focus.workflowId);
                snapshot = cfg ? cfg.buildSnapshot() : (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$local$2d$fiscal$2d$workflow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createPortfolioWorkflowById"])(focus.workflowId) ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$local$2d$fiscal$2d$workflow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createFapiTemplateWorkflow"])();
                ...
                if (stored?.rows?.length) {
                    const src = snapshot.blocks.find({
                        "BuilderPage.useEffect.src": (b)=>b.config?.sourceKind === "excel_workbook" || b.config?.sourceKind === "manual_table"
                    }["BuilderPage.useEffect.src"]);
                    if (src) {
                        src.config = {
                            ...src.config,
                            rows: stored.rows,
            ...
            const canvas = (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$workflow$2d$engine$2f$local$2d$fiscal$2d$workflow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["workflowDefinitionToCanvas"])(snapshot);
            const selectedNode = focus && canvas.nodes.find({
                "BuilderPage.useEffect": (n)=>n.id === focus.blockId
            }["BuilderPage.useEffect"]) || canvas.nodes.find({
                "BuilderPage.useEffect": (node)=>node.selected
            }["BuilderPage.useEffect"]) || canvas.nodes[0];
            const nodesWithSelection = canvas.nodes.map({
                "BuilderPage.useEffect.nodesWithSelection": (node)=>({
                        ...node,
            ...
            }["BuilderPage.useEffect.nodesWithSelection"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BuilderPage.useEffect": ()=>{
            ...
            const t = window.setTimeout({
                "BuilderPage.useEffect.t": ()=>setBuilderFocus(null)
            }["BuilderPage.useEffect.t"], 1200);
            return ({
                "BuilderPage.useEffect": ()=>window.clearTimeout(t)
            })["BuilderPage.useEffect"];
        }
    }["BuilderPage.useEffect"], [
        setBuilderFocus
...
_s(BuilderPage, "DHH2sWQXiOSME91WJzwj/rMKRK4=", false, function() {
    return [
...
//# sourceMappingURL=_3dfa9ed7._.js.map