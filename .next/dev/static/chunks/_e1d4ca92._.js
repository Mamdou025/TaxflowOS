...
// (registered as resource `workflows`). Renders the shared gallery transparent so
// the chat stays the prominent surface; picking a workflow opens its page as an
// inline workspace tab (pageKey `workflow:<id>`, rendered by the panel's PageBody)
// — so it keeps the workspace chrome + chat alongside, instead of navigating to a
// bare standalone route.
...
function WorkflowsHub() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_bc0e796ca3d7ea4640f9d74c95225eb3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$workflows$2d$hub$2f$workflows$2d$gallery$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WorkflowsGallery"], {
        dark: true,
        subtitle: "The standardized procedures. Pick one to view its process, run it, and review the result — all in one place.",
        onOpen: (def)=>openWindow({
...
_s(WorkflowsHub, "45PHDzcg7VRM8UCZLxdan8ZLNrQ=", false, function() {
    return [
...
//# sourceMappingURL=_e1d4ca92._.js.map