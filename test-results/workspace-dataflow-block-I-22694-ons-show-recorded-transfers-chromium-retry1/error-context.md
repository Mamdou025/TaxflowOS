...
- Name: workspace-dataflow.spec.ts >> block I/O replaces the strip and selected connections show recorded transfers
- Location: e2e/workspace-dataflow.spec.ts:37:5
