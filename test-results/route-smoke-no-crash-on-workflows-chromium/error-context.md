...
- Name: route-smoke.spec.ts >> no crash on /workflows
- Location: e2e/route-smoke.spec.ts:49:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/workflows
Call log:
  - navigating to "http://localhost:5173/workflows", waiting until "networkidle"
