...
- Name: route-smoke.spec.ts >> no crash on /t1134
- Location: e2e/route-smoke.spec.ts:49:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/t1134
Call log:
  - navigating to "http://localhost:5173/t1134", waiting until "networkidle"
