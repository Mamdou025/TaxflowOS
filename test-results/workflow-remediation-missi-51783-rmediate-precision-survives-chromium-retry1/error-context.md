...
- Name: workflow-remediation.spec.ts >> missing and blank values stop calculations; explicit defaults preserve real zero; intermediate precision survives
- Location: e2e/workflow-remediation.spec.ts:5:5
