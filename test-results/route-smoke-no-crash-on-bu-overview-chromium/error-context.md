...
- Name: route-smoke.spec.ts >> no crash on /bu-overview
- Location: e2e/route-smoke.spec.ts:49:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/bu-overview
Call log:
  - navigating to "http://localhost:5173/bu-overview", waiting until "networkidle"
