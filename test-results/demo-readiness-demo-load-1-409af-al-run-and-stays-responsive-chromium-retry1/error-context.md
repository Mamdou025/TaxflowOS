...
- Name: demo-readiness.spec.ts >> demo load 100 rows saves a real run and stays responsive
...
- generic [ref=e2]:
  ...
  - generic [ref=e7]:
    - generic [ref=e8]:
      ...
      - generic [ref=e63]:
        - group [ref=e64]:
          - generic "Workflow storage status" [ref=e65]: Saving changes…
        ...
        - generic [ref=e269]:
          ...
          - region "Workflow execution" [ref=e274]:
            - generic [ref=e275]:
              ...
              - paragraph [ref=e277]: Version 1 · Run local-tool-workflow-d61cbde6-f7ea-42cf-a5c2-e7127186078f
              - status [ref=e278]: Paused — ready when you are
            - link "Open this workflow in Run" [ref=e279] [cursor=pointer]:
              - /url: /w/custom%3Af072d00b-a437-4acb-90b0-8be4ea946038?run=local-tool-workflow-d61cbde6-f7ea-42cf-a5c2-e7127186078f
          ...
          - region "Trigger readiness" [ref=e350]:
            ...
            - generic [ref=e353]:
              ...
              - paragraph [ref=e357]: "Trial Balance · Uploaded: load-100.csv"
          - generic [ref=e358]:
          ...
          - generic [ref=e371]:
            - heading "Version 1 · 9/17/2026, 2:51:02 AM · warning" [level=3] [ref=e372]
            - paragraph [ref=e373]: Run ID local-tool-workflow-d61cbde6-f7ea-42cf-a5c2-e7127186078f · Started from run
  ...
  - region "Notifications alt+T":
    - list:
      ...
      - listitem [ref=e617]:
        - generic [ref=e622]: Test data updated
```