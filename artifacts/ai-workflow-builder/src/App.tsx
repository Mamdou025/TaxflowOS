        ...
        return (
          ...
          >
            ...
            <p style={{ margin: 0, color: '#6b7280', maxWidth: 440 }}>
              A new version of the app was deployed while you were using it. Please do a{' '}
              <strong>hard refresh</strong> to load the latest files.
            </p>
...
import { AppShell, ChatWorkspacePage } from '@/app-workspace';
...
const SourcesPage = lazy(() => import('@/app/sources/page').then((m) => ({ default: m.default })));
const ConnectionsPage = lazy(() =>
  import('@/app/connections/page').then((m) => ({ default: m.default })),
);
const WorkflowRunsPage = lazy(() =>
  import('@/app/workflows/runs/page').then((m) => ({ default: m.default })),
);
...
const WPage = lazy(() => import('@/app/w/[workflowId]/page').then((m) => ({ default: m.default })));
      ...
      <Route>
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            ...
            <a href="/" className="mt-4 text-primary underline block">
              Go home
            </a>
          </div>
        </div>
