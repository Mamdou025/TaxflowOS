...
import Image from '@/lib/next-image-shim';
...
function OutputDisplay({
  ...
  // Cast to the narrow type — we've already filtered out "component" via the ternary guard.
  const effectiveBuiltInConfig = (
    pluginConfig?.type !== "component" ? pluginConfig : builtInConfig
  ) as { type: "image" | "video" | "url"; field: string } | undefined;
