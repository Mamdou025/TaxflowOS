// ─────────────────────────────────────────────────────────────────────────────
// Text extraction for RAG. PDF via unpdf, Word via mammoth, spreadsheets via xlsx
// (→ CSV per sheet), plain text directly. Unlike the chat-attachment route there
// is NO char cap — stored documents are chunked instead, so the whole document is
// indexed. Ported from the web app's platform/rag/extract.ts.
// ─────────────────────────────────────────────────────────────────────────────
