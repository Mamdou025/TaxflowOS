...
import type { RelationshipTypesByFamilyPair, WorkflowRelationshipType } from './edge-types';
import {
...
export const RELATIONSHIP_TYPES_BY_FAMILY_PAIR: RelationshipTypesByFamilyPair = {
  Logic: {
    ...
    'Review / Validation': ['checked_by', 'requires_review_by', 'triggers_validation'],
  },
  Output: {
    'AI / Agent': AI_CONTEXT_RELATIONSHIP_TYPES,
  },
  ...
  'Review / Validation': {
    ...
    'Review / Validation': ['depends_on', 'blocks_until_resolved', 'certifies'],
  },
  Source: {
    'AI / Agent': AI_CONTEXT_RELATIONSHIP_TYPES,
...
export function getAllowedRelationshipTypesForFamilies(
  ...
  return [...(RELATIONSHIP_TYPES_BY_FAMILY_PAIR[sourceFamily]?.[targetFamily] || [])];
}
