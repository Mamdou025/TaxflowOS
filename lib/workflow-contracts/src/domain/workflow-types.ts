...
export type OutputMappingPreviewItem = {
  ...
  mappedProtectedValues: Array<{
    ...
    relationshipType: Extract<WorkflowRelationshipType, 'included_in_handoff' | 'maps_to_output'>;
  }>;
  candidateLogicMappings: Array<{
    ...
    relationshipType: Extract<
      WorkflowRelationshipType,
      'feeds_output_input' | 'included_in_output_preview' | 'maps_to_output_candidate'
    >;
  }>;
