...
function rollupRuleFromRecord(record: Record<string, unknown>, index: number): RollupRule | null {
...
export function collectRollupRulesFromBackendInput(value: unknown): RollupRule[] {
...
export function collectMappedRowsFromRollupInput(value: unknown): HierarchyMappedRow[] {
